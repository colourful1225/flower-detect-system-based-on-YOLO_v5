...
from Recognition import Ui_MainWindow
...
class RecMainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None, *args, **kwargs):
        ...
        QWindowCtrls(self, exit_title="基于YOLOv5的花卉识别系统",  # 退出确认框标题
        ...
        # 加载训练的模型权重
        self.model.load_model(model_path=abs_path("weights/best-yolov5nu.pt", path_type="current"))
